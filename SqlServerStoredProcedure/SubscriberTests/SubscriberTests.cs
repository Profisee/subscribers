    ...
    public class SubscriberTests
    {
        ...
        public static void ClassInit(TestContext context)
        {
            ...
            _subscriberTestContext
                .AddConfigurationProperty(SqlServerStoredProcedureSubscriber.ConnectionStringPropertyName, "A")
                .AddConfigurationProperty(SqlServerStoredProcedureSubscriber.StoredProcPropertyName, "A");
        }
        ...
        {
            var subscriber = new SqlServerStoredProcedureSubscriber();
